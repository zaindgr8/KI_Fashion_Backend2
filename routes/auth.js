    ...
    try {
      if (role === 'supplier' && supplierProfile) {
        const supplierPayload = {
          name: name, // Always use person's name for Supplier.name
          company: supplierProfile.company || name, // Fallback to name ONLY if company is blank
          email: supplierProfile.email || email,
          phone: supplierProfile.phone || phone,
          phoneAreaCode: supplierProfile.phoneAreaCode || phoneAreaCode,
          alternatePhone: supplierProfile.alternatePhone || undefined,
          alternatePhoneAreaCode: supplierProfile.alternatePhoneAreaCode || undefined,
      ...
      if (( role === 'buyer') && distributorProfile) {
        ...
        const buyerPayload = {
          ...
          phoneAreaCode: distributorProfile.phoneAreaCode || phoneAreaCode,
